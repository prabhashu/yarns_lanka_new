...
export default function Footer() {
  ...
  return (
    <footer className="bg-brand-black text-white pt-24 pb-12 border-t border-white/10 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-3xl h-[400px] bg-brand-gold/10 blur-[120px] rounded-full pointer-events-none"></div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-20">
          ...
          <div className="space-y-6 flex flex-col items-center text-center md:items-start md:text-left md:block">
            ...
            <div className="flex gap-4 pt-2 justify-center md:justify-start">
              <a href="#" className="w-10 h-10 rounded-xl border border-white/20 flex items-center justify-center text-white/80 hover:text-brand-black hover:border-brand-gold hover:bg-brand-gold transition-all duration-300 hover:-translate-y-1">
                <Facebook size={18} />
              </a>
              <a href="#" className="w-10 h-10 rounded-xl border border-white/20 flex items-center justify-center text-white/80 hover:text-brand-black hover:border-brand-gold hover:bg-brand-gold transition-all duration-300 hover:-translate-y-1">
                <Instagram size={18} />
          ...
          <div className="flex flex-col items-center text-center md:items-start md:text-left md:block mt-8 md:mt-0">
            <h4 className="font-sans text-xs uppercase tracking-[0.2em] font-semibold text-brand-gold mb-6 md:mb-8 border-b border-white/10 pb-4 inline-block">Company</h4>
            <ul className="space-y-4">
              {['Home', 'About Us', 'Collections', 'Contact'].map((item) => (
                <li key={item}>
                  <Link href={item === 'Home' ? '/' : `/${item.toLowerCase().replace(' ', '-')}`} className="text-sm text-white/70 hover:text-brand-gold transition-colors duration-300 flex items-center justify-center md:justify-start group">
          ...
          {/* Collections */}
          <div className="flex flex-col items-center text-center md:items-start md:text-left md:block mt-8 md:mt-0">
            <h4 className="font-sans text-xs uppercase tracking-[0.2em] font-semibold text-brand-gold mb-6 md:mb-8 border-b border-white/10 pb-4 inline-block">Our Range</h4>
            <ul className="space-y-4">
              {[
                ...
                <li key={item.name}>
                  <Link href={`/collections/${item.slug}`} className="text-sm text-white/70 hover:text-brand-gold transition-colors duration-300 flex items-center justify-center md:justify-start group">
                    <span className="w-0 h-[1px] bg-brand-gold mr-0 transition-all duration-300 group-hover:block md:group-hover:w-3 md:group-hover:mr-2 hidden md:block"></span>
                    {item.name}
                  </Link>
                </li>
          ...
          {/* Contact */}
          <div className="flex flex-col items-center text-center md:items-start md:text-left md:block mt-8 md:mt-0">
            <h4 className="font-sans text-xs uppercase tracking-[0.2em] font-semibold text-brand-gold mb-6 md:mb-8 border-b border-white/10 pb-4 inline-block">Contact</h4>
            <ul className="space-y-6">
              ...
              <li className="flex flex-col md:flex-row items-center md:items-start justify-center md:justify-start gap-2 md:gap-4 group">
                ...
                <div className="flex flex-col">
                  <a href="mailto:Info@yarnslanka.com" className="text-sm text-white/70 hover:text-brand-gold transition-colors">Info@yarnslanka.com</a>
                  <a href="mailto:yarnslanka@gmail.com" className="text-sm text-white/70 hover:text-brand-gold transition-colors">yarnslanka@gmail.com</a>
                </div>
              </li>
            </ul>
          </div>
